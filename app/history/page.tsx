...
export default async function Page() { const user = await requireAreaAccessForPage("appels_offres"); if (user.role !== "COMMERCIAL") redirect("/forbidden"); return <CommercialHistoryWorkspace rows={buildHistoryWorkspace(await getCommercialSecondaryRecords(user))} />; }
